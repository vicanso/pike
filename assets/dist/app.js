...
(function (f) {
    ...
    */
      ...
      */
			...
			defaults$$1._set('pie', helpers.clone(defaults$$1.doughnut));
			defaults$$1._set('pie', {
				cutoutPercentage: 0
			});
     ...
     */
				function initConfig(config) {
					...
					config.options = helpers.configMerge(defaults$$1.global, defaults$$1[config.type], config.options || {});
     ...
     */
				...
				helpers.color = !color ? function (value) {
					...
					if (value instanceof CanvasGradient) {
						value = defaults$$1.global.defaultColor;
					}
      ...
      */
					descriptors: function descriptors(chart) {
						...
						this._plugins.concat(config.plugins || []).forEach(function (plugin) {
							...
							if (opts === true) {
								opts = helpers.clone(defaults$$1.global.plugins[id]);
							}
     ...
     */
			...
			module.exports = function (Chart) {
				...
				function parseLineHeight(options) {
					return helpers.options.toLineHeight(helpers.valueOrDefault(options.lineHeight, 1.2), helpers.valueOrDefault(options.fontSize, defaults$$1.global.defaultFontSize));
				}
			...
			module.exports = function (Chart) {
				...
				Chart.scaleService = {
					...
					getScaleDefaults: function getScaleDefaults(type) {
						...
						return this.defaults.hasOwnProperty(type) ? helpers.merge({}, [defaults$$1.scale, this.defaults[type]]) : {};
					},
     ...
     */
      ...
      */
			...
			defaults$$1._set('global', {
				elements: {
					arc: {
						backgroundColor: defaults$$1.global.defaultColor,
						borderColor: '#fff',
						borderWidth: 2
					}
				}
			...
			var defaultColor = defaults$$1.global.defaultColor;
			...
			module.exports = Element.extend({
				...
				draw: function draw(chartArea) {
					...
					ctx.lineWidth = helpers.valueOrDefault(vm.borderWidth, defaults$$1.global.elements.point.borderWidth);
			...
			defaults$$1._set('global', {
				elements: {
					rectangle: {
						backgroundColor: defaults$$1.global.defaultColor,
						borderColor: defaults$$1.global.defaultColor,
    ...
    */
     ...
     */
				inherits: function inherits$$1(extensions) {
					var me = this;
			...
			module.exports = function () {
				...
				return {
					...
					beforeDatasetDraw: function beforeDatasetDraw(chart, args) {
						...
						var color = view.backgroundColor || defaults$$1.global.defaultColor;
      ...
      */
				...
				return {
					...
					beforeUpdate: function beforeUpdate(chart) {
						...
						if (legendOpts) {
							helpers.mergeIf(legendOpts, defaults$$1.global.legend);
			...
			module.exports = function (Chart) {
				...
				Chart.Title = Element.extend({
					...
					fit: function fit() {
						...
						var opts = me.options;
						var display = opts.display;
						var fontSize = valueOrDefault(opts.fontSize, defaults$$1.global.defaultFontSize);
						var minSize = me.minSize;
				...
				return {
					...
					beforeUpdate: function beforeUpdate(chart) {
						...
						if (titleOpts) {
							helpers.mergeIf(titleOpts, defaults$$1.global.title);
				...
				var LinearScale = Chart.LinearScaleBase.extend({
					...
					getTickLimit: function getTickLimit() {
						...
						if (me.isHorizontal()) {
							...
							var tickFontSize = helpers.valueOrDefault(tickOpts.fontSize, defaults$$1.global.defaultFontSize);
    ...
    */
      ...
      */
					getLabelWidth: function getLabelWidth(label) {
						...
						var tickFontSize = helpers.valueOrDefault(ticksOpts.fontSize, defaults$$1.global.defaultFontSize);
...
var getRuquesetCountChart = function getRuquesetCountChart(ctx) {
  var labels = [];
  for (var i = 0; i < 24; i++) {
    for (var j = 0; j < 12; j++) {
      var hour = i;
