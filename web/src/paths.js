...
export const CONFIGS_PATH = `${prefix}/configs`;
export const UPDATE_CONFIG_PATH = `${prefix}/configs/:name`;
export const ADD_UPSTREAM_PATH = `${prefix}/add-upstream`;
export const UPDATE_UPSTREAM_PATH = `${prefix}/update-upstream/:name`;
